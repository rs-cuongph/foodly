...
export const MESSAGES = {
  ...
  MSG_031: 'Please set a password between 8 and 24 characters including letters and numbers.',
  ...
  MSG_UPLOAD_FILE_TYPE: 'Please upload a file in mp4, mov, mp3, jpg, jpeg, or png format.',
  ...
  MSG_UPLOAD_DOCUMENT_TYPE: 'Please upload a document in PDF, Excel, Word, or text format.',
  MSG_UPLOAD_MAX_IMG: 'Exceeded the maximum number of uploaded images (5 images).',
  MSG_ERROR_DELETE_DEPARTMENT: 'Cannot delete this item because it has been used in previous records.',
  ...
  MSG_DUPLICATE_HOSPITAL: 'The hospital name has already been registered before.',
  ...
  MSG_MESSAGE_MAX_LENGTH: 'Please enter a message no more than 1000 characters.',
