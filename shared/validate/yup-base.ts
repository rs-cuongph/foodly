...
const defaultMessage = {
  ...
  string: {
    ...
    max: ({ label, max, errorMsg }: { label: string; max: number; errorMsg?: string }) => {
      const field = getValue(LABEL, label)
...
yup.addMethod<yup.StringSchema>(yup.string, 'validPassword', function (this, errorMsg?: string) {
  return this.test(
    'validPassword',
...
yup.addMethod<yup.StringSchema>(yup.string, 'validEmail', function (this, errorMsg?: string) {
  return this.test('validEmail', errorMsg || getMessageAddMethod.validEmail, function (input) {
    if (!input) return true
...
yup.addMethod<yup.StringSchema>(yup.string, 'notEmoji', function (this, errorMsg?: string) {
  return this.test('notEmoji', errorMsg || getMessageAddMethod.notEmoji, function (input) {
    if (!input) return true
...
yup.addMethod<yup.StringSchema>(
  ...
  function (this: yup.StringSchema, field: string, errorMsg?: string) {
    return this.test('same-as', errorMsg || getMessageAddMethod.sameAs, function (value) {
...
yup.addMethod<yup.StringSchema>(
  ...
  'minDate',
  function (this: yup.StringSchema, field: string, errorMsg?: string) {
    return this.test('min-date', errorMsg || getMessageAddMethod.minDate, function (value) {
...
yup.addMethod<yup.StringSchema>(
  ...
  function (this, maxLength?: number, errorMsg?: string) {
    return this.test(
      ...
      function (value) {
        if (typeof maxLength === 'number' && toArray(value).length > maxLength) {
          return false
        }
        return true
      }
...
yup.addMethod<yup.StringSchema>(yup.string, 'maxPresent', function (this, errorMsg?: string) {
  return this.test(
    'maxPresent',
...
yup.addMethod(yup.array, 'transformFilterEmpty', function (this, defaultValue?: any[]) {
