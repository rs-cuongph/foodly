...
import { DateSchema, DateSchemaConstructor, StringSchema, StringSchemaConstructor } from 'yup'
...
declare module 'yup' {
    interface StringSchema extends yup.StringSchema {
        ...
        validPasswordLength(this: yup.StringSchema, errorMsg?: string): yup.StringSchema
        validEmail(this: yup.StringSchema, errorMsg?: string): yup.StringSchema
        sameAs(this: yup.StringSchema, field: string, errorMsg?: string): yup.StringSchema
        ...
        minDate(this: yup.StringSchema, field: string, errorMsg?: string): yup.StringSchema
        isValidPhoneNumber(this: yup.StringSchema, errorMsg?: string): yup.StringSchema
    }
